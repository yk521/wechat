...
import com.springmvc.utils.AppContextUtils;
...
public final class ApiConfig extends Observable implements Serializable {
	...
	private static final long serialVersionUID = 673215114688708966L;
     ...
     */
    public ApiConfig( boolean enableJsApi) {
        this.appid = "wxaac84f28ff85395b";
        this.secret = "c84e9aceef82ca4fe4c35a02f6608fe1";
    ...
    public String getAccessToken() {
        ...
        try {
            ...
            if (time > 15000 && this.tokenRefreshing.compareAndSet(false, true)) {
//                LOG.debug("准备刷新token.............");
                initToken(now);
            }
        } catch (Exception e) {
...
//        });
//        //刷新工作做完，将标识设置回false
    	//accessToken = AppContextUtils.getBean(AccessTokenService.class).getAccessToken().getAccess_token();
        this.tokenRefreshing.set(false);
    }
